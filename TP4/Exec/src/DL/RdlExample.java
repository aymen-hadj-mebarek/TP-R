...
import org.tweetyproject.logics.rdl.semantics.DefaultSequence;
...
public class RdlExample {
	...
	static void defaultRuleTest() throws Exception{
		...
		DefaultTheory th = parser.parseBeliefBaseFromFile(RdlExample.class.getResource("/ressources/example_default_theory.txt").getFile());
	...
	static void extensionTest() throws Exception {
		RdlParser parser = new RdlParser();
		DefaultTheory t = parser.parseBeliefBaseFromFile(RdlExample.class.getResource("/ressources/example_default_theory.txt").getFile());

...
public class FolExample {
	...
	public static void main(String[] args) throws ParserException, IOException{
		...
		System.out.println("ANSWER 1: " + prover.query(bs, (FolFormula)parser.parseFormula("Flies(penguin)")));
		System.out.println("ANSWER 2: " + prover.query(bs, (FolFormula)parser.parseFormula("forall X: (exists Y: (Flies(X) && Flies(Y) && X/==Y))")));
		System.out.println("ANSWER 3: " + prover.query(bs, (FolFormula)parser.parseFormula("penguin == penguin")));
		System.out.println("ANSWER 4: " + prover.query(bs, (FolFormula)parser.parseFormula("penguin /== penguin")));
		System.out.println("ANSWER 5: " + prover.query(bs, (FolFormula)parser.parseFormula("perroquet /== penguin")));
		...
		bs = parser.parseBeliefBaseFromFile("src/resources/examplebeliefbase2.fologic");
		System.out.println("\nParsed BeliefBase: " + bs);
